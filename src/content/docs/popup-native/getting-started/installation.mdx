...
The SDK is distributed as a binary Swift package from [`MagicFeedback/DeepdotsSDK-SPM`](https://github.com/MagicFeedback/DeepdotsSDK-SPM). It exposes the library product `DeepdotsSDK`.

In Xcode, go to **File → Add Package Dependencies…**, enter the repository URL and pick version `0.5.0`:
...
The package manifest itself is binary-based:
